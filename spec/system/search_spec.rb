...
describe 'Search', type: :system, js: true do
  ...
  let!(:taxon_composer_a) { create(:taxon, name: "作曲家A", taxonomy_id: taxonomy_composer.id)}
  let!(:taxon_composer_b) { create(:taxon, name: "作曲家B", taxonomy_id: taxonomy_composer.id)}
  ...
  let!(:classification_a) { create(:classification, musicpost_id: musicpost_a.id, taxon_id: taxon_composer_a.id) }
  let!(:classification_b) { create(:classification, musicpost_id: musicpost_b.id, taxon_id: taxon_composer_b.id) }
